...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[100] bg-[#25D366] hover:bg-[#1ebe57] text-white p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center group"
    ...
    >
      ...
      {/* Tooltip (burbujita de texto al pasar el mouse) */}
      <span className="absolute right-20 bg-gray-900 text-white text-sm font-bold py-2 px-4 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg pointer-events-none border border-gray-700 hidden sm:block">
        ¡Hacenos tu consulta!
      </span>
    </a>
  );
